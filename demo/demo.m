...
%
% Note: If running in a MATLAB version pre-R2019, see demo_pre_R2019.m.
%
...
switch runcase
   ...
   case 1
      ...
      % Create the demo plot comparing the simulated surface energy balance to
      % the observed values from the KANM weather station.
   ...
   case 3
      ...
      % Set the run configuration. Use "userdata" option to swap the air temp.
      saveflag = false;
      sitename = 'kanm';
      forcings = 'kanm';
      smbmodel = 'skinmodel';
