function out = standardnames(whichdata)
   ...
   switch whichdata
      ...
      case 'ice1'
         ...
         out = {
            'surface_temperature', ...
            '', ... 'cumulative_melt_amount_in_lwe', ...
            '', ... 'cumulative_refreeze_amount_in_lwe', ...
            '', ... 'cumulative_sublimation_amount_in_lwe', ...
            '', ... 'cumulative_condensation_amount_in_lwe', ...
            '', ... 'cumulative_runoff_amount_in_lwe', ...
            '', ... 'cumulative_melt_amount_in_lwe', ...
            '', ... 'cumulative_refreeze_amount_in_lwe', ...
            '', ... 'surface_runoff_amount_in_lwe', ...
            '', ... 'subsurface_runoff_amount_in_lwe', ...
            };
