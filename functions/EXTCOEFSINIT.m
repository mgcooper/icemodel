function [  total_solar,                                                ...
   ...
   %
   % The outputs correspond to the center of each level, and the top surface of the
   % top grid cell, and the bottom surface of the bottom grid cell (thus the 502
   % values, for the current setup).
   %
   % There should be no limit to how coarse (like 10 cm) or how fine (like 1 mm)
   % you want to define your levels to be.  There is an upper limit of 500 levels
   % hard coded in the program that could be changed if you want/need to.
   %
