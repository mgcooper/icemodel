function [  surf_mlt,                                                   ...
            ...
            f_liq,                                                      ...
            imelt,                                                      ...
            isubl] = ICEABLATION(Qm,Qe,Qf,surf_mlt,surf_frz,surf_rof,   ...
            surf_sub,surf_con,ro_ice,ro_liq,Lf,Ls,dz,dt_new,opts,f_ice,f_liq)
   ...
   if Qe < 0.0
      ...
      isubl = - Qe / (Ls * ro_liq) * dt_new;                   % [m w.e.]
