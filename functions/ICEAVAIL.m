function [  h_ice,                                                      ...
            ...
            h_air,                                                      ...
            potmelt,                                                    ...
            ASflag  ] = ICEAVAIL(h_ice,h_liq,h_air,isubl,ro_ice,ro_liq, ...
            ro_sno,Cp_sno,T_old,Tfp,xLf,h_tot,frac_ice,th_resid,lay2subl)
   ...
   %if lay2subl == true && frac_ice(1)*ro_ice && h_ice(1)<h_ice(2)
   if lay2subl == true && ro_sno(1) < 600 && h_ice(1)<h_ice(2)
      %if lay2subl == true && frac_ice(1)*ro_ice < 600 && h_liq(2) <= h_res
   ...
   potmelt = Cp_sno.*(T_old-Tfp)./xLf.*h_tot;
