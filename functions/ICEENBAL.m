function [T,errH,errT,f_ice,f_liq,OK] = ICEENBAL(T,f_ice,f_liq,k_liq,cv_ice, ...
   ...
   while any(errT > 1e-2) && iter < 50
      ...
      [aN,aP,aS,b,iM] = GECOEFS(T,ro_sno,cp_sno,f_liq,f_ice,Ls,Lf,dz,dt, ...
      ...
      [T,f_liq,f_ice,OK] = MZTRANSFORM(T,T_old,f_liq,f_wat,ro_liq,ro_wie,Tf, ...
         TL,TH,fcp,fliqmin,fliqmax,iM,OK);
