function [T, errH, errT, f_ice, f_liq, OK] = ICEENBAL(T, f_ice, f_liq, ...
   ...
   while any(errT > 1e-2) && iter < 50
      ...
      % test
      % correction1 = max(0.0, f_ice + f_liq - 1.0);
      % f_liq = f_liq - correction1;
      ...
      % correction2 = max(0.0, f_ice + f_liq - 1.0);
      % f_liq = f_liq - correction2;
   ...
   % correction3 = max(0.0, f_ice + f_liq - 1.0);
   % f_liq = f_liq - correction3;
