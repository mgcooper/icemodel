function [  T,                                                          ...
            ...
            d_drn,                                                      ...
            x_err,                                                      ...
            lcflag ] =  ICEMF(T,f_ice,f_liq,ro_ice,ro_liq,cv_ice,       ...
                        cv_liq,Lf,Ls,Lv,Tf,TL,fcp,xf_liq,Sc,Sp,         ...
                        JJ_therm,f_min,fopts,dz_therm,dt_new,Qe,        ...
                        liqflag,ro_iwe,d_liq,d_drn,d_evp,flmin)
...
% represents the change in f_liq due to melt/freeze. Evaporation/condensation is
% accounted for below. d_drn gets updated if layers are combined   
...
[  f_ice, ...
   ...
   x_err ]  =  ICESUBL(f_ice, f_liq, d_drn, ro_ice, ro_liq, Ls, Lv, ...
               f_min, f_liq_min, dz_therm, dt_new, Qe, liqflag);
...
%   column, since layers are removed within the loop
   ...
   for j = 1:JJ_therm
      ...
      [  f_liq(j2),  ...
         ...
         Sp(j2),     ...
         d_drn,      ...
         d_liq ]     =  COMBINEHEAT(f_liq, f_ice, T, Sc, Sp, Tf, TL,    ...
                        cv_ice, cv_liq, Lf, ro_ice, ro_liq, fcp, j1,    ...
                        j2, d_drn, d_liq, dz_therm, fopts);
