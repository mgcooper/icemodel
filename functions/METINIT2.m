function [met,opts] = METINIT2(opts)

% METINIT2 came from versions/v10 b/c for region runs i just do
% load(opts.metfname) so here i changed the load command to a reassignment
% so i can do load(opts.metfname) for both region and site-level runs

% re-activate this when/if i put all the metfiles in the input directory
%load([opts.path.input 'met/' opts.metfname];

% these load met-station forcing data for nearby catchments

% slv1
if strcmp(opts.metfname,      'met_slv1_kanm_2015_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANM_KANM_2015_15m.mat'];
elseif strcmp(opts.metfname,  'met_slv1_kanm_2015_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANM_KANM_2015_1hr.mat'];
...
elseif strcmp(opts.metfname,  'met_behar_kanm_2016_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANM_KANM_2016_1hr.mat'];   
elseif strcmp(opts.metfname,  'met_behar_kanm_2015_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANM_KANM_2015_15m.mat'];
elseif strcmp(opts.metfname,  'met_behar_kanm_2016_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANM_KANM_2016_15m.mat'];

% ak4
elseif strcmp(opts.metfname,  'met_ak4_kanl_2009_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2009_15m.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2010_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2010_15m.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2011_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2011_15m.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2012_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2012_15m.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2013_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2013_15m.mat'];   
elseif strcmp(opts.metfname,  'met_ak4_kanl_2014_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2014_15m.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2015_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2015_15m.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2016_15m.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2016_15m.mat'];   
elseif strcmp(opts.metfname,  'met_ak4_kanl_2009_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2009_1hr.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2010_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2010_1hr.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2011_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2011_1hr.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2012_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2012_1hr.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2013_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2013_1hr.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2014_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2014_1hr.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2015_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2015_1hr.mat'];
elseif strcmp(opts.metfname,  'met_ak4_kanl_2016_1hr.mat')
   opts.metfname = [opts.path.metData    'met_KANL_KANL_2016_1hr.mat'];
...
% catchment-scale RCM forcing file
   ...
   opts.metfname = [opts.path.metData opts.metfname];
end
