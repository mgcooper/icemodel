function [Qm,Qf] = MFENERGY(albedo,Qsi,Qli,Qle,Qh,Qe,Qc,Tsfc,Tf,Tair,wspd, ...
      De,ea,roL,Pa,cv_air,emiss,SB,k_eff,T,dz,epsilon,scoef,chi)
   ...
   if Tsfc >= Tf
      ...
      % otherwise, compute energy needed to reach melt temp (freeze energy)
   else
      ...
      % xes0 = VAPOR(Tf,Tf,true); % assume melting
      % xQe = LATENT(De,xS,ea,xes0,roL,epsilon,Pa);
