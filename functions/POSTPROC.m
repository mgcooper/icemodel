...
% Compute bulk density, heat capacity, thermal conductivity, and a full surface
% and subsurface energy balance. Don't do this for large simulations if time or
% disk space is limited, instead compute them after the simulation.
