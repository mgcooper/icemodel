function [Sc,Sp] = SFCFLIN(Tair,Qsi,Qli,ea,albedo,De,Pa,wspd,cv_air,emiss, ...
      SB,roL,Tf,chi,Tsfc,scoef,liqflag)
   %SFCFLIN Linearize the surface energy balance equation w/form S = Sc + Sp*T
   ...
   Sc = Sc_Qle + Sc_Qh + Sc_Qe + chi*Qsi*(1.0-albedo) + emiss*Qli;
