%--------------------------------------------------------------------------
%   COMPUTE THE SATURATION VAPOR DENSITY WITHIN THE ICE AND THE RELEASE OF
%   LATENT HEAT DUE TO WATER VAPOR DIFFUSION WITHIN THE ICE
%--------------------------------------------------------------------------

function [  H_vap,                                                      ...
            d_ro_vap_dT,                                                ...
            ro_vap_sat,                                                 ...
            gamma_vap   ]   =   VAPORHEAT(T,f_liq,f_ice,Tf,Rv,Ls)
