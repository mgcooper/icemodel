...
% magnus formula: ea = A*exp(B*T/C+T) and coeffs for saturation vapor pressure
% over water (Buck 1981). Note: temperatures for Buck's equations are in deg C,
% and vapor pressures are in mb.  Do the adjustments so that the calculations
% are done with temperatures in K, and vapor pressures in Pa. (1 mb = 100 Pa)
%
% Formula:
