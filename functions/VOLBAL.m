...
% This means the cv cannot acommodate the ice even without residual water
        else
            xliq    =   h_liq_j;
...
% This means the cv can acommodate the ice + some but not all free water
    elseif xliq > 0

        h_liq_j     =   h_liq_j-xliq;       % drain free water as needed
        h_air_j     =   0.0;
        
% This means the cv can acommodate all the ice + free water
    else
