...
while iter <= maxiter
   ...
   if Qsi > 0
   [  Sc,                                                               ...
      chi   ]  =  UPDATEEXTCOEFS(Qsi,albedo,grid_spect,JJ_spect,        ...
                  dz_spect,grid_therm,JJ_therm,dz_therm,dz,z_walls,     ...
   ...
   [  T,                                                                ...
      ...
      [  Qe,                                                            ...
         ...
         Qm,                                                            ...
         Qf,                                                            ...
         balance ]   =  SEBFLUX(T,Tsfc,Tair,Qsi,Qli,albedo,wspd,Pa,ea,  ...
      ...
      [  T,                                                             ...
         ...
         d_liq,                                                         ...
         d_evp,                                                         ...
         d_drn ]  =  ICEMF(T,f_ice,f_liq,ro_ice,ro_liq,cv_ice,cv_liq,   ...
                     Lf,Ls,Lv,Tf,TL,fcp,xf_liq,Sc,Sp,JJ_therm,f_min,    ...
                     fopts,dz_therm,dt_new,Qe,liqflag,ro_iwe,d_liq,     ...
                     d_drn,d_evp,flmin);
