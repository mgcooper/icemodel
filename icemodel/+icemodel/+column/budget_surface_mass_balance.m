function [T, f_ice, f_liq, d_liq, d_evp, d_rof, d_vap_liq, d_vap_ice, ...
      d_vap, budget] = budget_surface_mass_balance(T, f_ice, f_liq, ...
   ...
   %
   %  [T, f_ice, f_liq, d_liq, d_evp, d_rof, d_vap_liq, d_vap_ice, ...
   %     d_vap, budget] = icemodel.column.budget_surface_mass_balance( ...
   %     T, f_ice, f_liq, xf_liq, d_pevp, d_liq, d_evp, d_rof, ...
   ...
   %
   % Outputs
   %   T          - Updated column temperature [K].
