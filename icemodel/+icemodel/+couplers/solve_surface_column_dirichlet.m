function [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] = ...
      ...
      tppt, psfc, De, ea_atm, br_coefs, roL, liqflag, chi, solver, tol, maxiter, ...
   ...
   k_eff = BULKTHERMALK(xT_ice, xf_ice, xf_liq, ro_ice, k_liq);
   [T_sfc, ok_seb] = icemodel.surface.solve_surface_energy_balance(xT_sfc, ...
      ...
      roL, liqflag, chi, xT_ice, k_eff, dz, ro_sfc, snow_depth, opts);
   ...
   for cpliter = 1:cpl_maxiter
      ...
      [T_ice, f_ice, f_liq, k_eff, ok_ieb, n_iters] = ICEENBAL(T_sfc, ...
         xT_ice, xf_ice, xf_liq, 0.0, 0.0, Sc, Sp, dz, delz, fn, dt, JJ, ...
         k_liq, cv_ice, cv_liq, ro_ice, ro_liq, Ls, Lf, roLf, Tf, fcp, TL, ...
         TH, f_ell_min, f_ell_max, solver, tol, maxiter, alpha, use_aitken, ...
         jumpmax, debug);
