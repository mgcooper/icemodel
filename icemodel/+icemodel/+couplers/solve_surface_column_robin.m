function [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_ieb, n_iters] = ...
      ...
      Sc, Sp, dt, tair, swd, lwd, albedo, wspd, ppt, tppt, psfc, De, ea_atm, ...
      br_coefs, ro_air_Lv, liqflag, chi, solver, tol, maxiter, alpha, ...
   ...
   [Fc, Fp] = icemodel.surface.surface_flux_linearization(T_sfc, tair, swd, ...
      ...
      liqflag, chi, ro_sfc, snow_depth, opts);
      ...
      if ~ok_ieb
         if debug
            dumpIceEbSolveFailure("iceenbal_failed", T_sfc, Ts_diag, Ts_old, ...
               T_ice, f_ice, f_liq, k_eff, Sc, dt, Fc, Fp, cpliter, ...
               cpl_maxiter, cpl_Ts_tol, cpl_seb_tol, seb_res, ok_cpl, n_iters);
         end
         break
      end
