function [Ts, T, f_ice, f_liq, k_eff, ok, n_iters] = ...
      solve_surface_column_robin(xT, xf_ice, xf_liq, dz, delz, fn, Sc, ...
      dt, JJ, Ts, k_liq, cv_ice, cv_liq, ro_ice, ro_liq, Ls, Lf, roLf, Tf, ...
      fcp, TL, TH, f_ell_min, f_ell_max, tair, swd, lwd, albedo, wspd, ppt, ...
      tppt, psfc, De, ea_atm, roL, br_coefs, chi, liqflag, solver, tol, ...
      maxiter, ~, use_aitken, jumpmax, cpl_Ts_tol, cpl_seb_tol, ...
      cpl_maxiter, cpl_alpha, cpl_aitken, cpl_jumpmax, debug, ro_sfc, ...
      snow_depth, opts)
   ...
   [Fc, Fp] = icemodel.surface.surface_flux_linearization(Ts, tair, swd, ...
      lwd, albedo, wspd, ppt, tppt, psfc, De, ea_atm, roL, br_coefs, chi, ...
   ...
   for cpliter = 1:cpl_maxiter
      ...
      seb_res = icemodel.surface.surface_energy_balance_residual(Ts, tair, ...
         swd, lwd, albedo, wspd, ppt, tppt, psfc, De, ea_atm, chi, roL, ...
         br_coefs, CONDUCT(k_eff, T, dz, Ts), liqflag, ro_sfc, snow_depth, ...
         opts);
      ...
      Ts_0 = Ts;
      Ts = icemodel.numerics.aitken_scalar(Ts_2, Ts_1, Ts_0, ...
