function [T_sfc, T_ice, f_ice, f_liq, U_vap, k_eff, ok_seb, ok_ieb, ...
      ok_cpl, n_iters] = solve_surface_column_robin(T_sfc, xT_ice, xf_ice, ...
      ...
      cpl_aitken, cpl_jumpmax, ro_sfc, snow_depth, f_res_por, opts)
   ...
   % U_VAP is the fifth output, immediately after the prognostic phase state,
   % because the driver treats accepted face transport as a first-class
   % quantity.
   %
   %#codegen
