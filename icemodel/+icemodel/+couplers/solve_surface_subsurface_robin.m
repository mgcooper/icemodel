function [Ts, T, f_ice, f_liq, k_eff, ok, n_iters] = ...
      solve_surface_subsurface_robin( ...
   ...
   [Fc, Fp] = icemodel.surface.surface_flux_linearization(Ts, tair, swd, ...
      lwd, albedo, wspd, ppt, tppt, psfc, De, ea, cv_air, cv_liq, emiss, ...
      SB, roL, scoef, chi, Tf, liqflag, ro_sfc, snow_depth, opts);
   ...
   for cpliter = 1:cpl_maxiter
      ...
      [Fc, Fp] = icemodel.surface.surface_flux_linearization(Ts, tair, ...
         swd, lwd, albedo, wspd, ppt, tppt, psfc, De, ea, cv_air, cv_liq, ...
         emiss, SB, roL, scoef, chi, Tf, liqflag, ro_sfc, snow_depth, opts);
