function [Ts, T, f_ice, f_liq, k_eff, ok, n_iters] = ...
      ...
      cv_liq, ro_ice, ro_liq, Ls, Lf, roLf, Tf, fcp, TL, TH, f_ell_min, ...
      f_ell_max, tair, swd, lwd, albedo, wspd, ppt, tppt, psfc, De, ea_atm, ...
      roL, br_coefs, chi, liqflag, solver, tol, maxiter, ...
   ...
   [Fc, Fp] = icemodel.surface.surface_flux_linearization(Ts, tair, swd, ...
      lwd, albedo, wspd, ppt, tppt, psfc, De, ea_atm, roL, br_coefs, chi, liqflag, ro_sfc, snow_depth, opts);
