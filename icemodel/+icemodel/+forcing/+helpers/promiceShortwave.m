function [swd, swu, metadata, masks] = promiceShortwave(aws, kwargs)
   %PROMICESHORTWAVE Select physical public PROMICE shortwave channels.
   %
   %  [swd, swu, metadata, masks] = ...
   ...
   darkness_method = ...
      ...
      "zero fill when whole-hour maximum <= " ...
      + string(darkness_threshold_degrees) + " degrees";
   ...
   [swd, swd_metadata, swd_masks] = selectChannel( ...
      aws, "swd", "swd_cor", "dsr", ...
   ...
   [swu, swu_metadata, swu_masks] = selectChannel( ...
      aws, "swu", "swu_cor", "usr", ...
   ...
   masks = struct( ...
      ...
      'swd_negative_clamped', swd_masks.negative_clamped, ...
      'swd_darkness_fill', swd_masks.darkness_fill, ...
      'swu_corrected_used', swu_masks.corrected_used, ...
      'swu_raw_fallback', swu_masks.raw_fallback, ...
      'swu_negative_clamped', swu_masks.negative_clamped, ...
      'swu_darkness_fill', swu_masks.darkness_fill);
end

function [data, metadata, masks] = selectChannel( ...
      aws, raw_name, corrected_name, ...
   ...
   masks = struct('corrected_used', isfinite(corrected), ...
