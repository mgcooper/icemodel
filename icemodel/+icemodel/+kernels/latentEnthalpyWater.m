function [Le, Ls] = latentEnthalpyWater(T)
   ...
   %  cpv_i) via icemodel.vapor.vaporinit.
   %
   ...
   %  result, production code (icemodel.vapor.vappress, VAPORHEAT, etc.) correctly treats L as
   ...
   %        DOI: 10.1002/qj.4154
   %
   % See also: icemodel.vapor.vaporinit, icemodel.kernels.saturationVaporPressure
...
function Le = latentHeatVaporization(T, E0v, Rv, cvv, cvl, T0)
   ...
   %
   % In icemodel production code (icemodel.vapor.vaporinit), cp_liq and cp_ice refer to the
