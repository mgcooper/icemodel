function ksnow = snowThermalConductivity(T, f_ice, ro_ice, ro_sno, opts)
   %SNOWTHERMALCONDUCTIVITY Compute mixture thermal conductivity (12 options).
   %
   %  ksnow = snowThermalConductivity(T, f_ice, ro_ice, ro_sno, opts)
   %
   %  This is the archived multi-option thermal conductivity function.
   %  Production code uses GETKTHERMAL (Calonne 2019 Eq. 5 only).
   %
   % See also: GETKTHERMAL, GETGAMMA
   %
   %#codegen
