function fields = cumulativeoutputs()
   ...
   % final native sample rather than a mean. Runoff is a balance rather than a
   % strict cumulative sum: it can fall when evaporation exceeds the melt and
   % overflow arriving in the same step.
