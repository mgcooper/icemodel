function map = variables()
   ...
   'subl_evap', '',                                         'combined sublimation and evaporation flux (positive loss, negative deposition)', 'mWE/h'
   'refreeze_deposition', '',                               'combined meltwater refreezing and deposition flux',   'mWE/h'
   ...
   'tice10m', 'land_ice_temperature', 'QC-screened 10 m subsurface (firn) temperature', 'K'
   'tice10m_source', 'land_ice_temperature', 'unmodified source-derived 10 m subsurface (firn) temperature', 'K'
   'tice10m_qc_flag', '', '10 m thermistor quality flag (0=accepted, 1=source-range or reviewed-discontinuity failure, 2=unreviewed endpoint, 3=persistent unreviewed epoch)', '1'
   % --- verification/profile table support ---------------------------------
   'time',      '',                        'time',                           ''
   'datetime',  '',                        'time',                           ''
   'date',      '',                        'date',                           ''
   'latitude',  '',                        'latitude',                       'degrees_north'
   'longitude', '',                        'longitude',                      'degrees_east'
   'elevation', 'height_above_mean_sea_level', 'elevation above mean sea level', 'm'
   'depth',     'depth',                   'depth below surface',            'm'
   'depth_m',   'depth',                   'depth below surface',            'm'
   'start_depth', 'depth',                 'top depth of an interval below surface', 'm'
   'stop_depth',  'depth',                 'bottom depth of an interval below surface', 'm'
   'midpoint',    'depth',                 'midpoint depth below surface',    'm'
   'duration',  '',                        'observation duration',           'days'
   'start_date', '',                       'observation start date',         ''
   'end_date',   '',                       'observation end date',           ''
   'timestamp',   '',                      'timestamp',                      ''
   'start_year', '',                       'observation start year',         '1'
   'end_year',   '',                       'observation end year',           '1'
   'name_key',      '',                    'SUMup name key',                 '1'
   'reference_key', '',                    'SUMup reference key',            '1'
   'method_key',    '',                    'SUMup method key',               '1'
   'error',         '',                    'reported observation uncertainty', ''
   'name',          '',                    'source record name',             ''
   'density',       '',                    'snow or firn density',           'kg m-3'
   'density_kgm3',  '',                    'snow or firn density',           'kg m-3'
   'rho',           '',                    'snow or firn density',           'kg m-3'
   'temperature',   '',                    'temperature',                    'degC'
   'temp',          '',                    'temperature',                    'degC'
   'temperature_degC', '',                 'temperature',                    'degC'
   'subsurface_temperature', 'land_ice_temperature', 'subsurface temperature', 'K'
   'lwc',           '',                    'liquid water content',           'kg'
   'lwc_kg',        '',                    'liquid water content',           'kg'
   'snow_depth_m',  'surface_snow_thickness', 'snow depth',                  'm'
   'swe_kg_m2',     '',                    'snow water equivalent',          'kg m-2'
   'surface_temp_C', 'surface_temperature', 'surface temperature',           'degC'
   'snow_liquid_water_storage_m', '',      'column-integrated snow liquid water storage', 'm'
   'bottom_outflow_mps', '',               'bottom outflow rate',            'm s-1'
