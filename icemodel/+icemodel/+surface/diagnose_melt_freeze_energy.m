function [Qm, Qf] = diagnose_melt_freeze_energy(T_sfc, Qsn, Qln, Qh, ...
      Qe, Qc, Qa, tair, Qsi, Qli, albedo, wspd, ppt, tppt, psfc, ...
   ...
   %
   % The flux terms (Qsn, Qln, Qh, Qe, Qc, Qa) passed in must be evaluated at
   ...
   if T_sfc >= Tf
      ...
      Qf = -(icemodel.surface.surface_energy_balance_residual( ...
         Tf, tair, Qsi, Qli, albedo, wspd, ppt, tppt, psfc, ea_atm, ...
