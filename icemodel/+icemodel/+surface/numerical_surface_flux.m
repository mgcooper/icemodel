function [Q_sfc, dQ_sfc_dT_sfc] = numerical_surface_flux(T_sfc, tair, Qsi, ...
   ...
   %
   %  [Q_sfc, dQ_sfc_dT_sfc] = icemodel.surface.numerical_surface_flux(...)
   %
   ...
   %
   %   dQ_sfc_dT_sfc ≈ imag(Q_sfc(T_sfc + 1i*h)) / h,  h = 1e-10
   %
