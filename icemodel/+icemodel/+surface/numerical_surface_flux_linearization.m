function [Q_sfc, dQ_sfc_dTs] = numerical_surface_flux_linearization(T_sfc, ...
      tair, Qsi, Qli, albedo, wspd, ppt, tppt, psfc, De, ea_atm, br_coefs, ...
      roL, liqflag, chi, T_ice, k_eff, dz, ro_sfc, snow_depth, opts)
   %NUMERICAL_SURFACE_FLUX_LINEARIZATION Evaluate the SEB residual numerically.
   %
   %  [Q_sfc, dQ_sfc_dTs] = ...
   ...
   residual_fn = @(Ts_eval) icemodel.surface.surface_energy_balance_residual( ...
      ...
      br_coefs, roL, liqflag, chi, T_ice, k_eff, dz, ro_sfc, snow_depth, opts);
