function [d_pevp, pevp, Qe, T_sfc_phys] = potential_surface_vapor_tendency( ...
   ...
   [Qe, ~] = icemodel.surface.diagnose_turbulent_heat_fluxes(T_sfc_phys, ...
      tair, wspd, psfc, ea_atm, De, br_coefs, ro_sfc, snow_depth, ro_air_Lv, ...
      liqflag, opts);
