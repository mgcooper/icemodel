...
function [psi_m0, psi_mz, psi_h0, psi_hz, psi_q0, psi_qz] = ...
      stability_corrections_bulk_mo(L, z0m, z_u, z0h, z_t, z0q, z_q, is_stable)
   %STABILITY_CORRECTIONS_BULK_MO Return Monin-Obukhov stability corrections.
   %
