function info = promicesiteinfo(site)
   ...
   %    KAN_M - lower percolation / firn zone (~1270 m), curated recipe
   %    KAN_U - upper percolation / dry-snow margin (~1840 m), generic recipe
   %
   %  Role
   ...
   catalog = struct( ...
      ...
      'zone',      {"ablation",       "lower_percolation_firn", "upper_percolation_firn"}, ...
      'has_recipe', {true,            true,                    false}, ...
      'models',    {models,           models,                  models}, ...
      'note', { ...
      "Lower ablation zone (~670 m); curated KAN_L service-window recipe.", ...
      "Lower percolation/firn zone (~1270 m); curated KAN_M service-window recipe.", ...
      "Upper percolation/dry-snow margin (~1840 m); generic ablation recipe."});
