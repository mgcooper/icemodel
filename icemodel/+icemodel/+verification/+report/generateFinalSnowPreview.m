...
family_pngs = cell(numel(families), 1);
for family_idx = 1:numel(families)
   family_pngs{family_idx} = dir(fullfile( ...
      figure_root, families(family_idx), "**", "*.png"));
end
pngs = vertcat(family_pngs{:});
