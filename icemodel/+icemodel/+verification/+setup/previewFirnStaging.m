function manifests = previewFirnStaging(families, kwargs)
   ...
   arguments
      ...
      kwargs.promice_case_ids (1, :) string = "KAN_M"
      kwargs.retmip_case_ids (1, :) string = "dye2_16"
      kwargs.imau_case_ids (1, :) string = "S21"
      kwargs.research_site_case_ids (1, :) string = "humphrey"
   ...
   switch family
      case "promice"
         ...
         manifest = icemodel.verification.setup.importPromiceSites( ...
            kwargs.promice_dir, "case_ids", kwargs.promice_case_ids, ...
      ...
      case "imau"
         ...
         manifest = icemodel.verification.setup.importImau( ...
            kwargs.imau_dir, "case_ids", kwargs.imau_case_ids, ...
            "output_root", kwargs.output_root, "dry_run", false, ...
            "build_forcing", true, ...
            "forcing_sources", ["imau", kwargs.forcing_sources], ...
            "startdate", window.start, ...
            "enddate", window.end, ...
            "overwrite", kwargs.overwrite, ...
            "overwrite_family", kwargs.overwrite_family, ...
      ...
      case "research_site"
         ...
         manifest = icemodel.verification.setup.importResearchSites( ...
            kwargs.sumup_dir, "case_ids", kwargs.research_site_case_ids, ...
            "output_root", kwargs.output_root, "dry_run", false, ...
            "build_forcing", true, ...
      ...
      case "sumup"
         ...
         manifest = icemodel.verification.setup.importSumup( ...
            ...
            "dry_run", false, "build_forcing", true, ...
            "forcing_sources", kwargs.forcing_sources, ...
            "startdate", window.start, ...
            "enddate", window.end, ...
            "overwrite", kwargs.overwrite, ...
...
function manifest = stageRetmipPreviewCases(kwargs, rcm)
   ...
   for k = 1:numel(cases)
      ...
      manifest = icemodel.verification.setup.importRetmip( ...
         ...
         "output_root", kwargs.output_root, "dry_run", false, ...
         "build_forcing", true, ...
         "forcing_sources", ["retmip", kwargs.forcing_sources], ...
         "startdate", window.start, ...
         "enddate", window.end, ...
