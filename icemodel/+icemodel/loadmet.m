function [met, opts] = loadmet(opts, fileiter) %#codegen
   ...
   if coder.target('MATLAB')
      opts = icemodel.forcing.reconstruct.verifyPromiceFilledReadiness(opts, fileiter);
   elseif strcmpi(string(opts.forcings), "promice_filled") ...
         && ~icemodel.forcing.reconstruct.promiceFilledVerificationMatches(opts, fileiter)
