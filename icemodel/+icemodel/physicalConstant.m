function varargout = physicalConstant(varargin)
   ...
   % Notes:
   %
   %  k_ice: Yen (1981) value chosen for consistency with Calonne
   %  parameterization, Andersson and Inaba give 2.17 (IAPWS value).
   %
   %#codegen
   ...
   constants = struct( ...
      'Tf', 273.16, ...             % Triple point (used for freezing point), [K]
      ...
      'cvv', 1418.0, ...            % Specific heat of vapor at constant volume (Romps 2021) [J kg-1 K-1]
      'E0v', 2.3740e6, ...          % Internal energy difference: vapor vs liquid at triple point (Romps 2021) [J kg-1]
      'E0s', 0.3337e6, ...          % Internal energy difference: liquid vs solid at triple point (Romps 2021) [J kg-1]
      'k_air', 0.0241, ...          % Thermal conductivity of dry air at 0°C [W m-1 K-1]
      'k_ice', 2.071, ...           % Thermal conductivity of ice at 0°C [W m-1 K-1] (Yen 1981)
      ...
      'S0', 1361.0, ...             % Solar constant (TSI) [W m-2]
   ...
   % production uses the Ambaum (2020) formulation via VAPORINIT.
