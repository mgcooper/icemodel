function [Qm, Qf, Qh, Qe, Qc, Qle, balance, T_sfc, ea_atm, ok] = ENBALANCE( ...
      T_sfc, tair, Qsi, Qli, albedo, wspd, rh, ppt, tppt, psfc, De, T, k_eff, ...
      dz, chi, roL, br_coefs, liqflag, Tflag, solver, ro_sfc, snow_depth, opts)
   ...
   [T_sfc, ok] = SEBSOLVE(T_sfc, tair, Qsi, Qli, albedo, wspd, ppt, tppt, ...
      psfc, De, ea_atm, chi, roL, br_coefs, liqflag, T, k_eff, dz, ro_sfc, ...
      snow_depth, solver, false, opts);
