function [I0, dz, z_nodes, z_edges, tau_N, tau_S, solar_dwavel, qext, ...
      g, coalbedo, radii, wavel, dwavel, k_ext, kice, kabs] = ...
   ...
   %     EXTCOEFSINIT(opts, ro_ice)
   %  [I0, dz, z_nodes, z_edges, tau_N, tau_S, solar_dwavel, qext, g, ...
   %     coalbedo, radii, wavel, dwavel, k_ext, kice, kabs] = ...
   %     EXTCOEFSINIT(opts, ro_ice)
   %
