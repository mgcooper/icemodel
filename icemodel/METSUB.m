function [tair, swd, lwd, albedo, wspd, rh, psfc, ppt, tppt, De, ea] ...
      = METSUB(opts, metstep, dt_sum, dt_full, liqflag, Tf, tair_v, ...
   ...
   %       tppt_s, De_s, ea] = METSUB(opts, metstep, dt_sum, ...
   ...
   % _s variants, and re-compute ea prior to diagnosing the surface energy
   % balance (diagnose_surface_energy_balance)
