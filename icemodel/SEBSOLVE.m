function [T_sfc, ok] = SEBSOLVE(T_sfc, tair, Qsi, Qli, albedo, wspd, ppt, ...
      tppt, psfc, De, ea_atm, chi, roL, br_coefs, liqflag, T, k_eff, dz, ...
      ro_sfc, snow_depth, solver, debug, opts)
   ...
   switch solver
      ...
      case 1 % Newton-Rhapson - analytical derivative
         ...
         for iter = 1:maxiter
            old = T_sfc;
            [T_sfc, ok] = SFCTEMP(tair, Qsi, Qli, albedo, wspd, ppt, tppt, ...
               psfc, De, ea_atm, chi, roL, br_coefs, liqflag, ...
   ...
   if ~ok && debug
      dumpSebSolveFailure(solver, iter, T_sfc_old, T_sfc, tair, Qsi, Qli, ...
         albedo, wspd, ppt, tppt, psfc, De, ea_atm, chi, roL, br_coefs, ...
         liqflag, k_eff, T, dz, ro_sfc, snow_depth, ok_cpl, opts);
   end
