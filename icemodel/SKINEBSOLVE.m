function [Ts, T, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] = ...
   ...
   k_eff = icemodel.column.bulk_thermal_conductivity(xT, xf_ice, xf_liq, ro_ice, ...
      k_liq, 0);
   [Ts, ok_seb] = icemodel.surface.solve_surface_energy_balance(xTs, tair, ...
      swd, lwd, albedo, wspd, ppt, tppt, psfc, De, ea_atm, br_coefs, roL, ...
   ...
   % k_eff = icemodel.column.bulk_thermal_conductivity(xT, xf_ice, xf_liq, ro_ice, k_liq, k_vap);
   ...
   for cpliter = 1:cpl_maxiter
      ...
      [T, f_ice, f_liq, k_eff, ok_ieb, n_iters] = ...
         icemodel.column.solve_column_temperature(xT, ...
      ...
      seb_res = abs(icemodel.surface.surface_energy_balance_residual( ...
         ...
         br_coefs, roL, liqflag, chi, T, k_eff, dz, ...
