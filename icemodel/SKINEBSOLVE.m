function [Ts, T, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] = ...
      SKINEBSOLVE(xTs, xT, xf_ice, xf_liq, dz, delz, fn, dt, tair, swd, ...
      lwd, albedo, wspd, ppt, tppt, psfc, De, ea_atm, chi, roL, br_coefs, ...
      liqflag, ~, tol, maxiter, alpha, cpl_maxiter, cpl_Ts_tol, ...
