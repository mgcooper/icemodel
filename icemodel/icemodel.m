      ...
      for timestep = 1:numsteps
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            [T_sfc, T_ice, f_ice, f_liq, n_subfail, substep, dt, ok, ...
               forced_advance] ...
               = CHECKSUBSTEP(T_sfc, T_ice, f_ice, f_liq, xT_sfc, xT_ice, ...
               xf_ice, xf_liq, ro_ice, ro_liq, dt_sum, dt, dt_FULL_STEP, ...
               timestep, numsteps, substep, maxsubstep, n_subfail, opts.debug, ...
               eps, ok, force_advance_streak_dt, dt_FULL_STEP);

            if ~ok
               continue
            end

            force_advance_streak_dt = icemodel.updateForceAdvanceGuard( ...
