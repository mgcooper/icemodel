function [ice1, ice2, opts] = icemodel(opts)
   ...
   [ice1, ice2, T_sfc, T_ice, f_ice, f_liq, ~, Sp, r_eff, k_eff, fn, dz, delz, ...
      z_nodes, f_res_por] = icemodel.column.initialize_column_state(opts, tair, r_eff);
   ...
   for thisyear = 1:numyears
      ...
      for timestep = 1:numsteps
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            if solver <= 1 % Coupled Dirichlet surface-subsurface solve
               ...
               [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] ...
                  ...
                  De(metstep), ea_atm(metstep), br_coefs, ro_air_Lv, liqflag, ...
                  chi, solver, tol, maxiter, alpha, use_aitken, jumpmax, ...
            ...
            [d_pevp, ~, ~, ~] ...
               ...
               ea_atm(metstep), De(metstep), br_coefs, snow_depth, f_ice(1), ...
               f_liq(1), dt, dz(1), ro_air_Lv, liqflag, opts);
            ...
            [T_ice, f_ice, f_liq, d_liq, d_evp] = ...
               ...
               f_liq, xf_liq, d_pevp, d_liq, d_evp, f_res_por, f_ice_min);
            ...
            [xT_sfc, xT_ice, xf_ice, xf_liq, dt_sum, dt, liqflag, ro_air_Lv, ...
               ro_sfc, f_res_por] = icemodel.timestepping.updatesubstep( ...
               T_sfc, T_ice, f_ice, f_liq, dt_FULL_STEP, dt_sum, dt, TINY, ...
               snow_depth, opts);
         end
         ...
         [Qe, Qh, Qc, Qsn, Qln, Qa, Qm, Qf, Qbal] = ...
            ...
            tair(metstep), swd(metstep), lwd(metstep), albedo(metstep), ...
            wspd(metstep), ppt(metstep), tppt(metstep), psfc(metstep), ...
            De(metstep), ea_atm(metstep), T_ice, k_eff, dz, ro_air_Lv, ...
            chi, br_coefs, ro_sfc, snow_depth, liqflag, opts);
