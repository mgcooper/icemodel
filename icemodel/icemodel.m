function [ice1, ice2, opts] = icemodel(opts)
   ...
   [ice1, ice2, T_sfc, T_ice, f_ice, f_liq, r_eff, k_eff, fn, dz, delz, ...
      ...
      f_ice_min, f_liq_res] = icemodel.column.initialize_column_state( ...
      opts, tair, r_eff);
   ...
   for thisyear = 1:numyears
      ...
      for timestep = 1:numsteps
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            if solver == 1 % Coupled Dirichlet surface-subsurface solve
               ...
               [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] ...
                  ...
                  JJ, k_liq, cv_ice, cv_liq, ro_ice, ro_liq, Ls, Lf, roLf, ...
                  ...
                  ea_atm, br_coefs, roL, liqflag, chi, solver, tol, maxiter, ...
                  alpha, use_aitken, jumpmax, cpl_Ts_tol, cpl_seb_tol, ...
                  cpl_maxiter, cpl_alpha, cpl_aitken, cpl_jumpmax, ro_sfc, ...
                  snow_depth, opts);
         ...
         [Qe, Qh, Qc, Qsn, Qln, Qa, Qm, Qf, Qbal] = ...
            icemodel.surface.diagnose_surface_energy_balance(T_ice, ...
            T_sfc, tair(metstep), swd(metstep), lwd(metstep), ...
