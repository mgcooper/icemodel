function [ice1, ice2, opts] = icemodel(opts)
   ...
   [cv_ice, cv_liq, k_liq, Lf, Ls, Lv, ro_air, ...
      ro_ice, ro_liq, roLf, roLs, roLv, Tf] ...
   ...
   [I0, dz_spect, z_nodes_spect, z_edges_spect, tau_N, tau_S, solar_dwavel, ...
      k_bulk_lookup, r_eff] = icemodel.radiation.initialize_spectral_model( ...
      opts, ro_ice);
   ...
   for thisyear = 1:numyears
      ...
      for timestep = 1:numsteps
         ...
         ea_atm = icemodel.surface.atmospheric_vapor_pressure(tair(metstep), ...
            rh(metstep), liqflag);
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            if solver == 1 % Coupled Dirichlet surface-subsurface solve
               ...
               [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] ...
                  ...
                  xT_sfc, xT_ice, xf_ice, xf_liq, dz, delz, fn, Sc, Sp, dt, JJ, ...
                  k_liq, cv_ice, cv_liq, ro_ice, ro_liq, Ls, Lf, roLf, Tf, fcp, ...
                  TL, TH, f_ell_min, f_ell_max, tair(metstep), swd(metstep), ...
                  lwd(metstep), albedo(metstep), wspd(metstep), ppt(metstep), ...
                  tppt(metstep), psfc(metstep), De(metstep), ea_atm, chi, roL, ...
                  br_coefs, liqflag, seb_solver, tol, maxiter, use_aitken, ...
                  jumpmax, cpl_maxiter, cpl_Ts_tol, cpl_seb_tol, cpl_alpha, ...
                  cpl_aitken, cpl_jumpmax, opts.debug, ro_sfc, snow_depth, opts);
            ...
            elseif solver > 1 % Robin single-sweep and strong coupling modes
               ...
               [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_ieb, n_iters] ...
                  ...
                  T_ice, f_ice, f_liq, dz, delz, fn, Sc, dt, JJ, T_sfc, ...
                  k_liq, cv_ice, cv_liq, ro_ice, ro_liq, Ls, Lf, roLf, ...
                  ...
                  ea_atm, roL, br_coefs, chi, liqflag, solver, ...
            ...
            [T_sfc, T_ice, f_ice, f_liq, n_subfail, substep, dt, ok, ...
               ...
               f_liq, xT_sfc, xT_ice, xf_ice, xf_liq, ro_ice, ro_liq, dt_sum, ...
            ...
            [T_ice, f_ice, f_liq, d_liq, d_evp, d_lyr] ...
               = ICEMF(T_ice, f_ice, f_liq, ro_ice, ro_liq, cv_ice, cv_liq, ...
               Lf, Ls, Lv, Tf, TL, fcp, xf_liq, Sc, Sp, JJ, f_ice_min, dz(1), ...
               d_pevp, d_liq, d_evp, d_lyr, f_ell_min, f_liq_res);
            ...
            [xT_sfc, xT_ice, xf_ice, xf_liq, dt_sum, dt, liqflag, roL] ...
               ...
               f_liq, dt_FULL_STEP, dt_sum, dt, TINY, ro_ice, ro_liq, ro_air, ...
               cv_ice, cv_liq, roLv, roLs);
         end
         ...
         if strcmp(opts.output_profile, 'diagnostic')
            [Qe, Qh, Qc, Qm, ~, Qbal, thf_diag] = ...
               icemodel.surface.diagnose_surface_energy_fluxes(T_ice, T_sfc, ...
               tair(metstep), swd(metstep), lwd(metstep), ...
               albedo(metstep), wspd(metstep), ppt(metstep), ...
               tppt(metstep), psfc(metstep), De(metstep), ea_atm, k_eff, ...
               dz, roL, chi, br_coefs, ro_sfc, snow_depth, liqflag, opts);
         else
            [Qe, Qh, Qc, Qm, ~, Qbal] = ...
               icemodel.surface.diagnose_surface_energy_fluxes(T_ice, T_sfc, ...
               tair(metstep), swd(metstep), lwd(metstep), ...
