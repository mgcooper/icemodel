      ...
      for timestep = 1:numsteps
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            [T_sfc, T_ice, f_ice, f_liq, k_eff, n_subfail, substep, dt, ...
               ...
               force_advance_streak_dt, 'skinmodel');

            if ~ok
               continue
            end

            % CHECKPOINT STATE AND SUBSTEP TIME. skinmodel has one accept
            % site and no forced-advance branch: no physics runs between
            % CHECKSUBSTEP and this call, so a forced advance and a
            % genuine acceptance do the same thing here.
