function [ice1, ice2, opts] = skinmodel(opts)
   ...
   [ice1, ice2, T_sfc, T_ice, f_ice, f_liq, r_eff, k_eff, fn, dz, delz, ...
      ~, roL, liqflag] = icemodel.column.initialize_column_state( ...
      opts, tair, r_eff);
      ...
      for timestep = 1:numsteps
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] ...
               = SKINEBSOLVE(xT_sfc, xT_ice, xf_ice, xf_liq, dz, delz, fn, ...
               dt, tair(metstep), swd(metstep), lwd(metstep), ...
               albedo(metstep), wspd(metstep), ppt(metstep), ...
               tppt(metstep), psfc(metstep), De(metstep), ea_atm, chi, ...
               roL, br_coefs, liqflag, seb_solver, tol, maxiter, alpha, ...
               cpl_maxiter, cpl_Ts_tol, cpl_seb_tol, cpl_alpha, ...
               cpl_aitken, cpl_jumpmax, opts.debug, ...
