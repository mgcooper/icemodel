function [ice1, ice2, opts] = skinmodel(opts)
   ...
   r_eff = 0;
   [ice1, ice2, T_sfc, T_ice, f_ice, f_liq, ~, ~, r_eff, k_eff, fn, dz, ...
      delz, ~, ~] = icemodel.column.initialize_column_state(opts, tair, r_eff);
      ...
      for timestep = 1:numsteps
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] ...
               ...
               De(metstep), ea_atm(metstep), chi, ro_air_Lv, br_coefs, liqflag, seb_solver, ...
