function [ice1, ice2, opts] = skinmodel(opts)
   ...
   [cv_ice, cv_liq, k_liq, Ls, ro_air, ...
      ro_ice, ro_liq, roLs, roLv, Tf] = icemodel.physicalConstant( ...
      'cv_ice', 'cv_liq', 'k_liq', 'Ls', 'ro_air', 'ro_ice', 'ro_liq', ...
      'roLs', 'roLv', 'Tf');
   TINY = 1e-8;
   chi = 1.0;
   ...
   [ice1, ice2, T_sfc, T_ice, f_ice, f_liq, r_eff, k_eff, fn, dz, delz, ...
      ~, roL, liqflag, JJ] = icemodel.column.initialize_column_state( ...
      opts, tair, r_eff);
      ...
      for timestep = 1:numsteps
         ...
         while dt_sum + TINY < dt_FULL_STEP
            ...
            [T_sfc, T_ice, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] ...
               ...
               ea_atm, chi, roL, br_coefs, liqflag, seb_solver, ...
            ...
            [T_sfc, T_ice, f_ice, f_liq, n_subfail, substep, dt, ok, ...
               ...
               xT_sfc, xT_ice, xf_ice, xf_liq, ro_ice, ro_liq, dt_sum, dt, ...
