   ...
   methods (Test)
      ...
      function testSkinSolve(testCase)
         ...
         [T, f_ice, f_liq, k_eff, ok] = ...
            icemodel.column.solve_column_temperature(s.Ts, s.T, ...
            s.f_ice, s.f_liq, s.dz, s.delz, s.fn, s.opts.dt, ...
            s.tol, s.maxiter, s.alpha, false);
      ...
      function testSkinEbSolve(testCase)
         ...
         [Ts, T, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok_cpl] = ...
            ...
            s.psfc, s.ea_atm, s.ro_atm, s.cv_atm, s.nu_air, s.H_h, ...
            s.H_e, s.hv_atm, s.br_coefs, s.liqflag, s.chi, ...
         ...
         testCase.assertTrue(ok_seb && ok_ieb && ok_cpl);
         ...
         while testCase.keepMeasuring
            for n = 1:batch_size
               [Ts, T, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok_cpl] = ...
                  ...
                  s.chi, s.tol, s.maxiter, s.alpha, s.cpl_maxiter, ...
                  s.cpl_Ts_tol, s.cpl_seb_tol, s.cpl_alpha, s.cpl_aitken, ...
                  s.cpl_jumpmax, s.ro_sfc, s.snow_depth, s.opts);
            end
            if ~(ok_seb && ok_ieb && ok_cpl) || ...
      ...
      function testIceEbSolve(testCase)
         ...
         [Ts, T, f_ice, f_liq, ~, ~, k_eff, ~, ok_ieb] = ...
            ...
            s.f_liq, s.Sc, s.Sp, s.dz, s.delz, s.fn, s.opts.dt, s.tair, ...
            s.swd, s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, s.psfc, ...
            s.ea_atm, s.ro_atm, s.cv_atm, s.nu_air, s.H_h, s.H_e, ...
            s.hv_atm, s.br_coefs, s.liqflag, s.chi, 3, s.tol, ...
            s.maxiter, s.alpha, s.use_aitken, s.jumpmax, s.cpl_Ts_tol, ...
            s.cpl_seb_tol, s.cpl_maxiter, s.cpl_alpha, s.cpl_aitken, ...
            s.cpl_jumpmax, s.cpl_alpha_min, s.ro_sfc, s.snow_depth, ...
         ...
         while testCase.keepMeasuring
            for n = 1:batch_size
               [Ts, T, f_ice, f_liq, ~, ~, k_eff, ~, ok_ieb] = ...
                  ...
                  s.f_ice, s.f_liq, s.Sc, s.Sp, s.dz, s.delz, s.fn, ...
                  s.opts.dt, s.tair, s.swd, s.lwd, s.albedo, s.wspd, ...
                  s.ppt, s.tppt, s.psfc, s.ea_atm, s.ro_atm, s.cv_atm, ...
                  s.nu_air, s.H_h, s.H_e, s.hv_atm, s.br_coefs, ...
                  s.liqflag, s.chi, 3, s.tol, s.maxiter, s.alpha, ...
                  s.use_aitken, s.jumpmax, s.cpl_Ts_tol, s.cpl_seb_tol, ...
                  s.cpl_maxiter, s.cpl_alpha, s.cpl_aitken, s.cpl_jumpmax, ...
                  s.cpl_alpha_min, s.ro_sfc, s.snow_depth, s.opts.f_res_pore_ice, s.opts);
            end
