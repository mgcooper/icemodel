   ...
   methods (Test)
      function testUpdateState(testCase)
         ...
         [H, k_eff, dHdT, dLdT, drovdT, ro_vap] = ...
            ...
            s.ro_ice, s.ro_liq, s.ro_air, s.cv_ice, s.cv_liq, s.k_liq, ...
            s.roLf, s.Ls, s.Rv, s.Tf, s.fcp);
         ...
         while testCase.keepMeasuring
            for n = 1:batch_size
               [H, k_eff, dHdT, dLdT, drovdT, ro_vap] = ...
                  ...
                  s.f_wat, s.ro_ice, s.ro_liq, s.ro_air, s.cv_ice, ...
                  s.cv_liq, s.k_liq, s.roLf, s.Ls, s.Rv, s.Tf, s.fcp);
            end
      ...
      function testIceEnbal(testCase)
         ...
         [T, f_ice, f_liq, k_eff, ok] = icemodel.column.solve_column_enthalpy( ...
            ...
            s.delz, s.fn, s.opts.dt, s.JJ, s.k_liq, s.cv_ice, s.cv_liq, ...
            s.ro_ice, s.ro_liq, s.Ls, s.Lf, s.roLf, s.Tf, s.fcp, s.TL, ...
            s.TH, s.f_ell_min, s.f_ell_max, 1, s.tol, s.maxiter, ...
      ...
      function testIceEbSolve(testCase)
        ...
        [Ts, T, f_ice, f_liq, k_eff, ok_ieb] = ...
            ...
            s.f_liq, s.dz, s.delz, s.fn, s.Sc, s.Sp, s.opts.dt, s.JJ, ...
         ...
         while testCase.keepMeasuring
            for n = 1:batch_size
               [Ts, T, f_ice, f_liq, k_eff, ok_ieb] = ...
                  ...
                  s.JJ, s.k_liq, s.cv_ice, s.cv_liq, s.ro_ice, ...
                  ...
                  s.br_coefs, s.roL, s.liqflag, s.chi, ...
