classdef SebKernelPerfTest < matlab.perftest.TestCase
   ...
   methods (TestMethodSetup)
      function generateTestData(testCase)
         ...
         testCase.T_ice = testCase.Ta * ones(500, 1);
         testCase.T_ice = testCase.T_ice .* exp(-0.1 * z ./ z(end));
      end
   end
   ...
   methods (Test)
      function testSolver(testCase, seb_solver)
         ...
         [T_sfc, ok] = icemodel.surface.solve_surface_energy_balance( ...
            testCase.T_sfc0, testCase.Ta, testCase.Qsi, ...
            ...
            testCase.liqflag, testCase.chi, testCase.T_ice, ...
         ...
         testCase.assertThat(T_sfc, matlab.unittest.constraints.IsFinite)
         ...
         while testCase.keepMeasuring
            for n = 1:batch_size
               [T_sfc, ok] = icemodel.surface.solve_surface_energy_balance( ...
                  ...
                  testCase.chi, testCase.T_ice, testCase.k_eff, ...
                  testCase.dz, testCase.ro_sfc, ...
                  testCase.snow_depth, opts_sv);
            end

            if ~ok || ~isfinite(T_sfc)
