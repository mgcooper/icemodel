   ...
   methods (TestMethodSetup)
      function generateTestData(testCase)
         ...
         [testCase.cv_air, testCase.cv_liq, ...
            testCase.SB, testCase.Tf, testCase.ro_air_Lv] = ...
   ...
   methods (Test)
      function testSolver(testCase, seb_solver)
         ...
         [Ts, ok] = icemodel.surface.solve_surface_energy_balance( ...
            ...
            testCase.br_coefs, testCase.ro_air_Lv, testCase.liqflag, ...
            testCase.chi, testCase.T, testCase.k_eff, testCase.dz, ...
            [], [], opts_sv);
         ...
         while testCase.keepMeasuring
            for n = 1:batch_size
               [Ts, ok] = icemodel.surface.solve_surface_energy_balance( ...
                  testCase.Ts0, testCase.Ta, testCase.Qsi, testCase.Qli, ...
                  testCase.albedo, testCase.wspd, testCase.ppt, testCase.tppt, ...
                  testCase.Pa, testCase.De, testCase.ea_atm, testCase.br_coefs, ...
                  testCase.ro_air_Lv, testCase.liqflag, testCase.chi, ...
                  testCase.T, testCase.k_eff, testCase.dz, [], [], opts_sv);
            end
