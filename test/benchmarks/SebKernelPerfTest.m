classdef SebKernelPerfTest < matlab.perftest.TestCase
   ...
   methods (TestMethodSetup)
      function generateTestData(testCase)
         ...
         testCase.ea = VAPPRESS(testCase.Ta, testCase.liqflag) ...
            .* testCase.rh / 100;
         ...
         z0_bulk = 1e-3;
         z_tair = 3;
         [testCase.De, testCase.scoef] = WINDCOEF(testCase.wspd, z0_bulk, z_tair);
   ...
   methods (Test)
      function testSolver(testCase, seb_solver)
         ...
         [Ts, ok] = SEBSOLVE(testCase.Ts0, testCase.Ta, testCase.Qsi, ...
            ...
            testCase.tppt, testCase.Pa, testCase.De, testCase.ea, ...
            testCase.chi, testCase.roL, testCase.scoef, ...
         ...
         while testCase.keepMeasuring
            for n = 1:batch_size
               [Ts, ok] = SEBSOLVE(testCase.Ts0, testCase.Ta, ...
                  ...
                  testCase.De, testCase.ea, testCase.chi, testCase.roL, ...
                  testCase.scoef, testCase.liqflag, testCase.T, ...
