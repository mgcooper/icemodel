...
function profiles = buildProfiles(s)
   ...
   [Sc_functions, chi_functions] = icemodel.column.shortwave_source_term(s.swd, s.albedo, ...
      s.I0, s.dz_spect, s.tau_N, s.tau_S, s.solar_dwavel, s.dz, ro_sno, ...
      s.z_nodes, s.z_nodes_spect, s.z_edges_spect, k_lookup_empty);

   [Sc_lookup, chi_lookup] = icemodel.column.shortwave_source_term(s.swd, s.albedo, ...
      s.I0, s.dz_spect, s.tau_N, s.tau_S, s.solar_dwavel, s.dz, ro_sno, ...
