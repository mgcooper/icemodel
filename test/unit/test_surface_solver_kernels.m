...
function test_sebsolve_bulk_mo_converges_with_numeric_derivative(testCase)
   ...
   residual = icemodel.surface.surface_energy_balance_residual(Ts, s.tair, ...
      ...
      s.ea_atm, s.chi, s.roL, s.br_coefs, CONDUCT(s.k_eff, s.T, s.dz, Ts), ...
...
function test_iceebsolvedirichlet_converges_on_synthetic_column(testCase)
   ...
   if isempty(which('icemodel.couplers.solve_surface_column_dirichlet'))
      testCase.assumeTrue(false, ...
         ['icemodel.couplers.solve_surface_column_dirichlet is not ', ...
