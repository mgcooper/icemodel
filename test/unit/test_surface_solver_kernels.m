...
function test_sfcflux_derivative_matches_finite_difference(testCase)
   ...
   [Q_sfc, dQ_sfc_dTs] = ...
      ...
      s.De, Ts, s.ea_atm, s.roL, s.br_coefs, s.chi, s.liqflag, s.k_eff, ...
      s.T, s.dz, s.ro_sfc, s.snow_depth, s.opts);
   ...
   Fplus = icemodel.surface.turbulence.bulk_richardson.evaluate_surface_flux( ...
      s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, s.psfc, ...
      s.De, Ts + h, s.ea_atm, s.roL, s.br_coefs, s.chi, s.liqflag, s.k_eff, ...
      s.T, s.dz, s.ro_sfc, s.snow_depth, s.opts);
...
function test_sfcflux_includes_precipitation_advection(testCase)
   ...
   Q_sfc_dry = icemodel.surface.turbulence.bulk_richardson.evaluate_surface_flux( ...
      ...
      Ts, s.ea_atm, s.roL, s.br_coefs, s.chi, s.liqflag, s.k_eff, s.T, ...
...
function test_iceebsolvedirichlet_converges_on_synthetic_column(testCase)
   ...
   [T_old, f_ice_old, f_liq_old, k_eff_old, ok_ieb_old] = ...
      ...
      s.Fc, s.Fp, s.Sc, s.Sp, s.dz, s.delz, s.fn, s.opts.dt, s.JJ, ...
      s.k_liq, s.cv_ice, s.cv_liq, s.ro_ice, s.ro_liq, s.Ls, s.Lf, ...
      s.roLf, s.Tf, s.fcp, s.TL, s.TH, s.f_ell_min, s.f_ell_max, 1, ...
      s.tol, s.maxiter, s.alpha, s.use_aitken, s.jumpmax, false);
