...
function test_sfcflux_derivative_matches_finite_difference(testCase)
   % numerical_surface_flux_linearization should return a derivative consistent with a
   ...
   [Q_sfc, dQ_sfc_dTs] = ...
      icemodel.surface.numerical_surface_flux_linearization( ...
   ...
   h = 1e-5;
   Fplus = icemodel.surface.numerical_surface_flux_linearization( ...
      Ts + h, s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, s.psfc, ...
      s.De, s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, s.T, s.k_eff, ...
      s.dz, s.ro_sfc, s.snow_depth, s.opts);

   % Recompute at a small negative perturbation.
   Fminus = icemodel.surface.numerical_surface_flux_linearization( ...
      Ts - h, s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, s.psfc, ...
      s.De, s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, s.T, s.k_eff, ...
      s.dz, s.ro_sfc, s.snow_depth, s.opts);
...
function test_sfctemp_finds_small_surface_residual(testCase)
   ...
   % Verify convergence using numerical_surface_flux_linearization, which defines the
   % residual that solve_surface_temperature minimizes.
   Q_sfc = icemodel.surface.numerical_surface_flux_linearization( ...
      Ts, s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, s.psfc, ...
      s.De, s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, s.T, s.k_eff, ...
      s.dz, s.ro_sfc, s.snow_depth, s.opts);
...
function test_sfcflux_includes_precipitation_advection(testCase)
   ...
   Q_sfc_dry = icemodel.surface.numerical_surface_flux_linearization( ...
      Ts, s.tair, s.swd, s.lwd, s.albedo, s.wspd, 0.0, tppt, s.psfc, s.De, ...
      s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, s.T, s.k_eff, ...
      s.dz, s.ro_sfc, s.snow_depth, s.opts);

   % Compute the SEB residual with Qa.
   Q_sfc_wet = icemodel.surface.numerical_surface_flux_linearization( ...
      Ts, s.tair, s.swd, s.lwd, s.albedo, s.wspd, ppt, tppt, s.psfc, s.De, ...
      s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, s.T, s.k_eff, ...
      s.dz, s.ro_sfc, s.snow_depth, s.opts);
...
function test_iceebsolvedirichlet_converges_on_synthetic_column(testCase)
   ...
   [Ts, T, f_ice, f_liq, k_eff, ok_seb, ok_ieb, ok, n_iters] = ...
      ...
      s.psfc, s.De, s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, ...
   ...
   residual_coupled = icemodel.surface.surface_energy_balance_residual(Ts, ...
      ...
      s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, T, k_eff, s.dz, ...
   ...
   residual_old = icemodel.surface.surface_energy_balance_residual(Ts_old, ...
      s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, s.psfc, s.De, ...
      s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, T_old, k_eff_old, s.dz, ...
      s.ro_sfc, s.snow_depth, s.opts);
...
function test_surface_flux_diagnostics_match_energy_balance_residual(testCase)
   ...
   [Qe, Qh, Qc, Qsn, Qln, Qa, Qm, ~, balance] = ...
      ...
      s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, s.psfc, s.De, ea_atm, s.T, ...
...
function test_skinsolve_returns_finite_bounded_state(testCase)
   ...
   [T, f_ice, f_liq, k_eff, ok, iter] = ...
      icemodel.column.solve_column_temperature(s.T, s.f_ice, s.f_liq, ...
      s.dz, s.delz, s.fn, s.opts.dt, s.Ts, s.tol, s.maxiter, s.alpha, ...
      false);
...
function test_robin_coupler_supports_monin_obukhov_on_synthetic_column(testCase)
   ...
   residual = icemodel.surface.surface_energy_balance_residual(Ts, s.tair, ...
      ...
      s.ea_atm, s.br_coefs, s.roL, s.liqflag, s.chi, T_rob, k_eff_rob, ...
      s.dz, ...
      s.ro_sfc, s.snow_depth, s.opts);
