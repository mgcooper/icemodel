...
function test_sfcflux_derivative_matches_finite_difference(testCase)
   ...
   [Fsfc, Fdot] = SFCFLUX(s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, ...
      s.tppt, s.psfc, s.De, Ts, Qc, s.ea_atm, s.roL, s.br_coefs, s.chi, ...
      s.liqflag);

   h = 1e-5;
   Fplus = SFCFLUX(s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, s.tppt, ...
      s.psfc, s.De, Ts + h, Qc, s.ea_atm, s.roL, s.br_coefs, s.chi, ...
      s.liqflag);
   Fminus = SFCFLUX(s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, ...
      s.tppt, s.psfc, s.De, Ts - h, Qc, s.ea_atm, s.roL, s.br_coefs, ...
      s.chi, s.liqflag);
...
function test_sfctemp_finds_small_surface_residual(testCase)
   ...
   [Ts, ok] = SFCTEMP(s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, ...
      s.tppt, s.psfc, s.De, s.ea_atm, s.chi, s.roL, s.br_coefs, s.liqflag, Qc);
...
function test_sfcflux_includes_precipitation_advection(testCase)
   ...
   Fsfc_dry = SFCFLUX(s.tair, s.swd, s.lwd, s.albedo, s.wspd, 0.0, tppt, ...
      s.psfc, s.De, Ts, Qc, s.ea_atm, s.roL, s.br_coefs, s.chi, s.liqflag);
...
function test_sebsolve_converges_across_root_finders(testCase)
   ...
   for seb_solver = 0:2
      ...
      residual = fSEB(Ts, s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, ...
         s.tppt, s.psfc, s.De, s.ea_atm, s.chi, s.roL, s.br_coefs, ...
...
function test_enbalance_matches_energy_balance_residual(testCase)
   ...
   [Qm, ~, Qh, Qe, Qc, Qle, balance, Ts, ea_atm] = ENBALANCE(s.Ts, s.tair, ...
      s.swd, s.lwd, s.albedo, s.wspd, rh, s.ppt, s.tppt, s.psfc, s.De, ...
      s.T, s.k_eff, s.dz, s.chi, s.roL, s.br_coefs, s.liqflag, true, ...
...
function test_robin_coupler_supports_bulk_mo_on_synthetic_column(testCase)
   ...
   residual = fSEB(Ts, s.tair, s.swd, s.lwd, s.albedo, s.wspd, s.ppt, ...
      s.tppt, s.psfc, s.De, s.ea_atm, s.chi, s.roL, s.br_coefs, ...
      CONDUCT(k_eff_rob, T_rob, s.dz, Ts), s.liqflag, s.ro_sfc, ...
      s.snow_depth, s.opts);
